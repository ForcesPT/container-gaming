...
> **UPDATE 2026-07-07 GAMEPAD (STAGE 3b) ROOT CAUSE FOUND + FIXED — the v1.6.2 interposer's JSIOCGNAME returned 0 instead of the name length, so SDL3's IsJoystick rejected the device; patched the interposer .so + validated IsGamepad=1 with Steam's own libSDL3; image rebuilt, real-controller test pending.**
>
